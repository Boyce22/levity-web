...
export default function ShareWorkspaceModal({
  ...
  return (
    <div className="fixed inset-0 z-200 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
      <div className="bg-[#1c1c1e] w-full max-w-105 rounded-2xl shadow-2xl border border-white/10 flex flex-col overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="p-5">
          ...
          {!inviteUrl ? (
            ...
            >
              {loading ? (
                <>
                  <Loader2 className="w-5 h-5 animate-spin" /> Generating Secure
                  Link...
                </>
              ) : (
                <>
