...
import { extractStorageUrls, isImageUrl } from "@/ui/utils/attachments";
import { deleteFileAction } from "@/infra/storage/upload";
    ...
    <div className="space-y-4">
                    ...
                    if (props.type === "checkbox") {
                      ...
                      return (
                        <input
                          ...
                          className="!pointer-events-auto mt-1 mr-2 h-3.5 w-3.5 cursor-pointer accent-[var(--app-primary)] !opacity-100"
                        />
                      );
                    }
                    return <input {...props} />;
      ...
      {!isEditing && attachments.length > 0 && (
        <div className="space-y-2 pt-2">
          <h4 className="px-1 text-[10px] font-bold tracking-widest uppercase opacity-40">Attachments</h4>
