...
export function StatusBadges({
  ...
  return (
    <div className="mb-2 flex flex-wrap items-center gap-2">
      <span
        className="inline-flex items-center gap-1.5 rounded-[4px] px-2 py-0.5 text-[10px] font-bold tracking-widest uppercase"
        style={{
      ...
      >
        <span className="h-1.5 w-1.5 animate-pulse rounded-sm bg-emerald-400" />
        Active
      </span>
